...
$GLOBALS['gLang']['lang_install'] = array(
	'SC_GBK' => '简体中文版',
	'TC_BIG5' => '繁体中文版',
	'SC_UTF8' => '简体中文 UTF8 版',
	'TC_UTF8' => '繁体中文 UTF8 版',
	...
	'uc_url_empty' => '您没有填写 XPpass 的 URL，请返回填写',
	'uc_url_invalid' => 'URL 格式错误',
	'uc_url_unreachable' => 'XPpass 的 URL 地址可能填写错误，请检查',
	'uc_ip_invalid' => '无法解析该域名，请填写站点的 IP',
	'uc_admin_invalid' => 'XPpass 创始人密码错误，请重新填写',
	'uc_data_invalid' => '通信失败，请检查 XPpass 的URL 地址是否正确 ',
	'uc_dbcharset_incorrect' => 'XPpass 数据库字符集与当前应用字符集不一致',
	'uc_api_add_app_error' => '向 XPpass 添加应用错误',
	'uc_dns_error' => 'XPpass DNS解析错误，请返回填写一下 XPpass 的 IP地址',

	'XPpass_ucurl_invalid' => 'XPpass 的URL为空，或者格式错误，请检查',
	'XPpass_ucpw_invalid' => 'XPpass 的创始人密码为空，或者格式错误，请检查',
